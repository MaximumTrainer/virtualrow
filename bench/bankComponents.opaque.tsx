...
export const CurvedLandscapeElements: React.FC<CurvedLandscapeProps> = ({
  ...
  const curveFoliageMats = useMemo(() => [
    makeSwayFoliageMaterial({ color: colors.tree, roughness: 0.78, metalness: 0.0, transmission: 0, thickness: 0.6, sheen: 0.45, sheenColor: new THREE.Color(colors.treeHighlight), sheenRoughness: 0.7 }, swayTime),
    makeSwayFoliageMaterial({ color: colors.tree, roughness: 0.74, metalness: 0.0, transmission: 0, thickness: 0.5, sheen: 0.52, sheenColor: new THREE.Color(colors.treeHighlight), sheenRoughness: 0.65 }, swayTime),
    makeSwayFoliageMaterial({ color: colors.tree, roughness: 0.70, metalness: 0.0, transmission: 0, thickness: 0.4, sheen: 0.58, sheenColor: new THREE.Color(colors.treeHighlight), sheenRoughness: 0.6 }, swayTime),
    makeSwayFoliageMaterial({ color: colors.tree, roughness: 0.68, metalness: 0.0, transmission: 0, thickness: 0.3, sheen: 0.65, sheenColor: new THREE.Color(colors.treeHighlight) }, swayTime),
  ], [colors, swayTime]);
